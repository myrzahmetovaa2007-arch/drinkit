  ...
  return (
    <div className="space-y-32 py-20">
      ...
      <section className="text-center max-w-4xl mx-auto">
        <h1 className="text-6xl font-extrabold">About <span className="text-blue-600">DrinkIt</span></h1>
      ...
      <section className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-12">
          {[
            ...
            <div
              key={i}
              className="p-8 shadow-lg rounded-2xl bg-white hover:shadow-xl transition"
            >
              <h3 className="text-2xl font-semibold mb-3">{item.title}</h3>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div
                key={i}
                className="bg-white p-8 text-center rounded-2xl shadow-md hover:shadow-lg transition"
              >
